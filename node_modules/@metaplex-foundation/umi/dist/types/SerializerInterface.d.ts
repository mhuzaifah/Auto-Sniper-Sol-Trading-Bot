...
export interface SerializerInterface {
     ...
     */
    tuple: <T extends any[], U extends T = T>(items: WrapInSerializer<[...T], [...U]>, options?: TupleSerializerOptions) => Serializer<T, U>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    array: <T, U extends T = T>(item: Serializer<T, U>, options?: ArraySerializerOptions) => Serializer<T[], U[]>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    map: <TK, TV, UK extends TK = TK, UV extends TV = TV>(key: Serializer<TK, UK>, value: Serializer<TV, UV>, options?: MapSerializerOptions) => Serializer<Map<TK, TV>, Map<UK, UV>>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    set: <T, U extends T = T>(item: Serializer<T, U>, options?: SetSerializerOptions) => Serializer<Set<T>, Set<U>>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    option: <T, U extends T = T>(item: Serializer<T, U>, options?: OptionSerializerOptions) => Serializer<Option<T> | Nullable<T>, Option<U>>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    nullable: <T, U extends T = T>(item: Serializer<T, U>, options?: NullableSerializerOptions) => Serializer<Nullable<T>, Nullable<U>>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    struct: <T extends object, U extends T = T>(fields: StructToSerializerTuple<T, U>, options?: StructSerializerOptions) => Serializer<T, U>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    enum<T>(constructor: ScalarEnum<T> & {}, options?: ScalarEnumSerializerOptions): Serializer<T>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    dataEnum<T extends DataEnum, U extends T = T>(variants: DataEnumToSerializerTuple<T, U>, options?: DataEnumSerializerOptions): Serializer<T, U>;
    /**
     ...
     * @param options - A set of options for the serializer.
     */
    publicKey: (options?: PublicKeySerializerOptions) => Serializer<PublicKey | PublicKeyInput, PublicKey>;
}
/**
 * An implementation of the {@link SerializerInterface} that throws an error when called.
 * @category Serializers
 */
export declare function createNullSerializer(): SerializerInterface;
